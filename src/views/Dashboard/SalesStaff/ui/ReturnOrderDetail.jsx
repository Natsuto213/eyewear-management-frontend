...
export default function ReturnOrderDetail() {
    ...
    const fetchOrderDetail = async () => {
        try {
            ...
            console.log("Return ID:", response.data.result.returnExchangeId); // Kiểm tra returnExchangeId trong response
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-200">
                <p className="text-lg font-semibold">
                    Đang tải chi tiết yêu cầu trả hàng...
                </p>
            </div>
        );
    }
    ...
    const itemUrl = orderData.returnExchangeItems.map((item) => {
        return item.itemEvidenceURL;
    })[0];
                            ...
                            <div className="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
                                ...
                                <div className="p-6 space-y-5">
                                    ...
                                    {isApproved && (
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                            <p className="text-xs text-gray-500 mb-1">
                                                Thông tin tài khoảng khách hàng:
                                            </p>
                                            <p className="text-sm font-bold text-gray-800">
