      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <button
          ...
          className={`group relative flex flex-col items-center justify-center rounded-2xl border-2 p-4 transition-all ${
            payment === "VNPAY" ? "border-red-500 bg-red-50 shadow-md" : "border-zinc-100 bg-white hover:border-zinc-200"
          }`}
        >
        ...
        <button
          ...
          className={`group relative flex flex-col items-center justify-center rounded-2xl border-2 p-4 transition-all ${
            payment === "MOMO" ? "border-pink-500 bg-pink-50 shadow-md" : "border-zinc-100 bg-white hover:border-zinc-200"
          }`}
        >
