...
export default function ProductDetail() {
  ...
  const [errors, setErrors] = useState({}); // Khởi tạo state lỗi của các ô input số đo mắt vì hàm shandleBlurAction trả ra {} nên khởi tạo là {}
//   {
//   "leftCan": "Độ cận từ 0 đến -20.00",
//   "leftVien": "",
//   "leftLoan": "Phải là bội số của 0.25",
//   "leftLao": "",
//   "rightCan": "",
//   "rightVien": "Vui lòng chỉ nhập số",
//   "rightLoan": "",
//   "rightLao": ""
// }
  ...
  // Hàm xử lý khi rời khỏi ô input (onBlur), xử lý lỗi ở ô nhập số đo mắt
  const handleBlurAction = (field, value, type) => {
    const result = validateEyeDegree(value, type);
    setErrors((prev) => ({
      ...prev,
      //// Logic: Nếu hợp lệ thì xóa lỗi (""), nếu sai thì lấy tin nhắn từ hàm validate
          ...
          <div className="flex flex-col pl-4 lg:pl-10">
            ...
            {(isTrong || isKinhApTrong) && (
              <PrescriptionForm
                ...
                errors={errors} // Truyền state lỗi xuống
                onBlurAction={handleBlurAction} // Truyền hàm xử lý xuống
              />
            )}
